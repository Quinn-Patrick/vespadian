...
str = global.scores[1,0];
frt = global.scores[1,1];
dex = global.scores[1,2];
agi = global.scores[1,3];
int = global.scores[1,4];
wis = global.scores[1,5];
cha = global.scores[1,6];
spr = global.scores[1,7];
lvl = global.scores[1,8];

pAtk = global.stats[1,0];
pDef = global.stats[1,1];
spd = global.stats[1,2];
hit = global.stats[1,3];
